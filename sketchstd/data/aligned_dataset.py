...
class AlignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        for path_ in self.AB_paths:
            cur_path = path_ #[os.path.join(path_, "rendering", file) for file in os.listdir(os.path.join(path_, "rendering")) if file.endswith('.png')]
            imgs.append(cur_path)
        self.AB_paths = imgs #list(itertools.chain(*imgs))
    ...
    def __getitem__(self, index):
        ...
        AB = 255*(1- morphology.binary_dilation(1 - binary(AB_)/255, iterations=5))
